...
@Mod.EventBusSubscriber(modid = AICommand.MODID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class Config {
    ...
    private static final ForgeConfigSpec.ConfigValue<String> DEEPSEEK_API_KEY = BUILDER
            .comment("DeepSeek API key for command generation")
            .define("deepSeekApiKey", "");

    private static final ForgeConfigSpec.ConfigValue<String> OPENAI_API_KEY = BUILDER
            .comment("OpenAI API key for command generation")
            .define("openAIApiKey", "");

    private static final ForgeConfigSpec.EnumValue<AIProvider> AI_PROVIDER = BUILDER
